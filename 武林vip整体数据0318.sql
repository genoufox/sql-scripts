insert into TOTAL_VIP0318
  select b.game_ab,
    ...
    left join (select userid, sum(cash_need) / 100 as consumption_7
                 from bitask.t_dw_",var_game,"_glog_shoptrade
                where order_id > -1
                  and logtime >= sysdate - 7
                group by userid) h
    ...
    left join (select groupname,
                 ...
                 from bitask.t_dw_",var_game,"_dic_serverlist) j
    ...
    left join (select c.userid,
                 ...
                 from (select a.userid, b.f_city_name, count(*) as cnt
                         from (select userid, ip_num
                                 from bitask.t_dw_",var_game,"_glog_accountlogout
    ...
    left join bitask.t_dw_",var_game,"_account_status l
