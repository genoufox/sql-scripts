create table yy_zxsy_20170608_xq_v13_v18 as  
  select roleid_, pay, 
      CASE 
     ...
     (select roleid_, sum(cash_)/100 pay 
       ...
       where logtime >= date'2016-08-03' and logtime < date'2017-06-01'
         and groupname != 995
       group by roleid_ having sum(cash_)/100 >= 50000);
       
select * from yy_zxsy_20170608_xq_v13_v18;


create table yy_zxsy_20170608_xq_0601_1 as
...
select * from yy_zxsy_20170608_xq_0601_1;
